...
# Unit tests for SquashMatrixAPI::ApiResponseErrorsErrors
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiResponseErrorsErrors' do
  before do
    # run before each test
    @instance = SquashMatrixAPI::ApiResponseErrorsErrors.new
  end
  ...
  describe 'test an instance of ApiResponseErrorsErrors' do
    it 'should create an instance of ApiResponseErrorsErrors' do
      expect(@instance).to be_instance_of(SquashMatrixAPI::ApiResponseErrorsErrors)
    end
  end

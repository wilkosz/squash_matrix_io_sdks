...
# Unit tests for SquashMatrixAPI::ApiResponseErrors
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiResponseErrors' do
  before do
    # run before each test
    @instance = SquashMatrixAPI::ApiResponseErrors.new
  end
  ...
  describe 'test an instance of ApiResponseErrors' do
    it 'should create an instance of ApiResponseErrors' do
      expect(@instance).to be_instance_of(SquashMatrixAPI::ApiResponseErrors)
    end
  end

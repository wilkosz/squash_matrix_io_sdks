...
/**
* @module SquashMatrixClient/ApiClient
* @version 1.0.0
*/
...
* @alias module:SquashMatrixClient/ApiClient
* @class
*/
export default class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://api.squashmatrix.io/v1
         */
        this.basePath = 'https://api.squashmatrix.io/v1'.replace(/\/+$/, '');
    ...
    * @param {module:SquashMatrixClient/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:SquashMatrixClient/ApiClient}
*/

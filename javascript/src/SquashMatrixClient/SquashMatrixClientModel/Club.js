...
/**
* The Club model module.
* @module SquashMatrixClient/SquashMatrixClientModel/Club
* @version 1.0.0
*/
export default class Club {
    /**
    * Constructs a new <code>Club</code>.
    * @alias module:SquashMatrixClient/SquashMatrixClientModel/Club
    * @class
    */
    ...
    /**
    * Constructs a <code>Club</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:SquashMatrixClient/SquashMatrixClientModel/Club} obj Optional instance to populate.
    * @return {module:SquashMatrixClient/SquashMatrixClientModel/Club} The populated <code>Club</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('player_ids')) {
                obj['player_ids'] = ApiClient.convertToType(data['player_ids'], ['Number']);
            }
        }
        return obj;
    }

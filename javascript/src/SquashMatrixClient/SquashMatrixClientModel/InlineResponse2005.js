...
* @module SquashMatrixClient/SquashMatrixClientModel/InlineResponse2005
* @version 1.0.0
*/
export default class InlineResponse2005 {
    /**
    * Constructs a new <code>InlineResponse2005</code>.
    * @alias module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2005
    * @class
    */
    ...
    * @param {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2005} obj Optional instance to populate.
    * @return {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2005} The populated <code>InlineResponse2005</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = Game.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:SquashMatrixClient/SquashMatrixClientModel/Game} data
    */
    data = undefined;

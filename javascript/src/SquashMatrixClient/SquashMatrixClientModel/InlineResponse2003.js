...
* @module SquashMatrixClient/SquashMatrixClientModel/InlineResponse2003
* @version 1.0.0
*/
export default class InlineResponse2003 {
    /**
    * Constructs a new <code>InlineResponse2003</code>.
    * @alias module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2003
    * @class
    */
    ...
    * @param {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2003} obj Optional instance to populate.
    * @return {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2003} The populated <code>InlineResponse2003</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = Player.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {module:SquashMatrixClient/SquashMatrixClientModel/Player} data
    */
    data = undefined;

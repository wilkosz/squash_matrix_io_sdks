...
* @module SquashMatrixClient/SquashMatrixClientModel/InlineResponse2004
* @version 1.0.0
*/
export default class InlineResponse2004 {
    /**
    * Constructs a new <code>InlineResponse2004</code>.
    * @alias module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2004
    * @class
    */
    ...
    * @param {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2004} obj Optional instance to populate.
    * @return {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse2004} The populated <code>InlineResponse2004</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Game]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:SquashMatrixClient/SquashMatrixClientModel/Game>} data
    */
    data = undefined;

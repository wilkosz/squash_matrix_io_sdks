...
import ApiResponseErrorsErrors from './ApiResponseErrorsErrors';
...
* @module SquashMatrixClient/SquashMatrixClientModel/ApiResponseErrors
* @version 1.0.0
*/
export default class ApiResponseErrors {
    /**
    * Constructs a new <code>ApiResponseErrors</code>.
    * @alias module:SquashMatrixClient/SquashMatrixClientModel/ApiResponseErrors
    * @class
    */
    ...
    * @param {module:SquashMatrixClient/SquashMatrixClientModel/ApiResponseErrors} obj Optional instance to populate.
    * @return {module:SquashMatrixClient/SquashMatrixClientModel/ApiResponseErrors} The populated <code>ApiResponseErrors</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiResponseErrors();
            ...
            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [ApiResponseErrorsErrors]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:SquashMatrixClient/SquashMatrixClientModel/ApiResponseErrorsErrors>} errors
    */
    errors = undefined;

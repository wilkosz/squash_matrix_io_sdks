...
* @module SquashMatrixClient/SquashMatrixClientModel/InlineResponse200
* @version 1.0.0
*/
export default class InlineResponse200 {
    /**
    * Constructs a new <code>InlineResponse200</code>.
    * @alias module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse200
    * @class
    */
    ...
    * @param {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse200} obj Optional instance to populate.
    * @return {module:SquashMatrixClient/SquashMatrixClientModel/InlineResponse200} The populated <code>InlineResponse200</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [Club]);
            }
        }
        return obj;
    }
    ...
    /**
    * @member {Array.<module:SquashMatrixClient/SquashMatrixClientModel/Club>} data
    */
    data = undefined;

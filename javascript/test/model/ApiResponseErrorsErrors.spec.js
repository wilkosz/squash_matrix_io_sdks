...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquashMatrixApi.ApiResponseErrorsErrors();
  });
  ...
  describe('ApiResponseErrorsErrors', function() {
    it('should create an instance of ApiResponseErrorsErrors', function() {
      // uncomment below and update the code to test ApiResponseErrorsErrors
      //var instane = new SquashMatrixApi.ApiResponseErrorsErrors();
      //expect(instance).to.be.a(SquashMatrixApi.ApiResponseErrorsErrors);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquashMatrixApi.Club();
  });
  ...
  describe('Club', function() {
    it('should create an instance of Club', function() {
      // uncomment below and update the code to test Club
      //var instane = new SquashMatrixApi.Club();
      //expect(instance).to.be.a(SquashMatrixApi.Club);
    });
    ...
    it('should have the property playerIds (base name: "player_ids")', function() {

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SquashMatrixApi.ApiResponseErrors();
  });
  ...
  describe('ApiResponseErrors', function() {
    it('should create an instance of ApiResponseErrors', function() {
      // uncomment below and update the code to test ApiResponseErrors
      //var instane = new SquashMatrixApi.ApiResponseErrors();
      //expect(instance).to.be.a(SquashMatrixApi.ApiResponseErrors);
    });
